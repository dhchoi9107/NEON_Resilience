...
bac=pd.read_csv(os.path.join(D,"plot_baci_diversity_26.csv"))
...
rob=pd.read_csv(os.path.join(D,"plot_disturbance_robust_26.csv"))
...
nbr=pd.read_csv(os.path.join(D,"plot_nbr_annual_26.csv"))
dnbr=delta(nbr,'nbr')
# Δstructure (LiDAR per-year)
py=pd.read_csv(os.path.join(D,"per_year_v2_26.csv"))
