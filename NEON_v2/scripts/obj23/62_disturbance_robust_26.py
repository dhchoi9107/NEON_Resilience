...
Output: plot_disturbance_robust_26.csv
"""
import numpy as np, pandas as pd
D=r"C:\Users\star1\Documents\GitHub\NEON_Resilience\NEON_v2\data"
ts=pd.read_csv(D+r"\plot_nbr_annual_26.csv")
han=pd.read_csv(D+r"\plot_hansen_loss_26.csv")
mtbs=pd.read_csv(D+r"\plot_mtbs_fire_26.csv")
...
m.to_csv(D+r"\plot_disturbance_robust_26.csv",index=False)
