...
Output: plot_disturbance_neon_26.csv  (NEON-native primary disturbance flag/type/year/severity)
"""
import re, numpy as np, pandas as pd
D=r"C:\Users\star1\Documents\GitHub\NEON_Resilience\NEON_v2\data"
ev=pd.read_csv(D+r"\plot_neon_events_26.csv",low_memory=False)
...
ins=pd.read_csv(D+r"\plot_insitu_disturbance_26.csv")
...
# remote robust
rob=pd.read_csv(D+r"\plot_disturbance_robust_26.csv")[['plotID','disturbed','dist_year','severity','d_fire','d_loss','d_spec']]
...
m.to_csv(D+r"\plot_disturbance_neon_26.csv",index=False)
