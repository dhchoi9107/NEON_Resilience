...
Output: plot_neon_events_26.csv
"""
...
if len(ev):
    ...
    ev.to_csv(r"C:\Users\star1\Documents\GitHub\NEON_Resilience\NEON_v2\data\plot_neon_events_26.csv",index=False)
    print("\nsaved plot_neon_events_26.csv")
