...
Out: papers/UNIFIED/figures/O3_productivity/O3_species_energy_26.png
     papers/UNIFIED/results/O3_productivity/species_energy_stats_26.csv
"""
...
tower = pd.read_csv(os.path.join(D, "site_tower_gpp_26.csv"))  # siteID, tower_gpp (annual gC/m2/yr)
...
out = os.path.join(OUTF, "O3_species_energy_26.png")
fig.savefig(out, dpi=200, bbox_inches="tight"); print("saved", out)
pd.DataFrame(rows).to_csv(os.path.join(OUTR, "species_energy_stats_26.csv"), index=False)
