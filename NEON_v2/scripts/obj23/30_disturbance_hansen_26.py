...
Output: plot_hansen_loss_26.csv (plotID, hansen_loss, hansen_lossyear, hansen_loss_frac, treecover2000)
"""
...
OUT=r"C:\Users\star1\Documents\GitHub\NEON_Resilience\NEON_v2\data\plot_hansen_loss_26.csv"
...
def lonlat(r):
    z=int(''.join(c for c in str(r.utmZone) if c.isdigit())); tr=Transformer.from_crs(f"EPSG:326{z:02d}","EPSG:4326",always_xy=True)
