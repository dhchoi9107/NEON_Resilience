...
Output: plot_year_insitu_26.csv (per plot-year fractions) + plot_insitu_disturbance_26.csv (plot summary)
"""
...
py.to_csv(D+r"\plot_year_insitu_26.csv",index=False)
...
ins.to_csv(D+r"\plot_insitu_disturbance_26.csv",index=False)
