...
- 맵핑 — 스크립트 `10·20·60·61`(DHI)·`120~122`(비선형)·`147`(forest type)·`149·150`(MODIS·PML GPP 검증) / 그림 `G01·G02`·`L01·L02`·`L03`·`L04`·**L05·L06**(GPP 검증) / 결과 `dhi_gpp_validation`·`dhi_gpp_triangulation`
