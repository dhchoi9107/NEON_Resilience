...
- **산점도 `N03`** (bivariate, 도메인 미통제): VCI_trend **r=−0.41**, FHD_trend **r=−0.40**(젊을수록 수직복잡도·엽층다양성 빠르게 축적→~200년 정체), Deep_Gap_trend **r=+0.29**(노령 갭 열림), LAI/Rugosity/Max_Ht/Canopy_Ht 음, Gini ns. (도메인·site 통제 혼합모델은 위 표·N01.)
