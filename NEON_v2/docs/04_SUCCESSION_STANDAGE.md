...
**(i) 다양성 ~ 임령: 직접효과 없음** (Hill q1 선형 p=0.54, 2차 p=0.99). 임령 자체가 다양성 수준을 정하지 않음 — DHI 생산성 혹형과 대조되는 정직한 null. **4지수 전부 확인**(`N09`): 사이트평균 r 알파 −0.03/−0.02, turnover −0.19, nestedness +0.13(lin p=0.04 경계). 큰 점(사이트평균)으로 보면 어느 지수도 뚜렷한 관계 없음.
