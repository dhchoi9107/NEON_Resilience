...
> 2026-07-09. 가설: **시간↑ → 식생 생장 → 구조 복잡도↑.** 이를 (A) 시간 trend의 정보량, (B) 임령(succession) 두 축으로 검증. Obj1(RS↔종) · Obj2(교란·시간동태)와 직접 연결.
...
| **Global 30m** (2025) | 30m | Landsat CCDC 변화점, 자연/조림 | ⏳ 북미 타일 11.4GB 다운로드 중 → 교차검증 예정 |
...
python scripts/obj23/140_stand_age.py                # (B), 존재하는 age 소스 자동 병합
```
