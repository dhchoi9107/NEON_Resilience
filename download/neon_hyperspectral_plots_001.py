...
Usage:
  python download/neon_hyperspectral_plots_001.py estimate       # check availability & size
  python download/neon_hyperspectral_plots_001.py download        # download all
  python download/neon_hyperspectral_plots_001.py download --site HARV  # single site
"""
...
DPID = "DP3.30006.001"  # directional (BRDF) corrected mosaic
BUFFER = 50  # meters around plot edge
OUTPUT_DIR = Path("E:/neon_lidar/hyperspectral_plots_001")
...
def estimate(site_filter=None, latest_only=False):
    ...
    print(f"Product: {DPID} (Hyperspectral Reflectance - Mosaic, directional (pre-BRDF))")
